...
export const Sidebar = (props: SidebarProps) => {
  ...
  return (
    <Show when={props.sidebarOpen()}>
      <div class="h-screen w-2/12 bg-gray-50">
        <div class="flex h-full flex-col">
          <div class="flex items-center space-x-4 border-y border-gray-400 bg-gray-200 px-3 py-1">
            <div class="text-3xl">
              <ImStack />
            </div>
            <div>New Topic</div>
          ...
          <div class="flex-1" />
          <div class="flex items-center space-x-4 border-y bg-gray-200 px-3 py-1">
            <div class="text-3xl">
              <FiHelpCircle />
            </div>
            <div>Help</div>
          ...
          <button
            class="flex items-center space-x-4 rounded-br-md border-y border-gray-400 bg-gray-200 px-3 py-1"
            onClick={() => {
              void fetch(`${api_host}/auth`, {
                method: "DELETE",
                headers: {
